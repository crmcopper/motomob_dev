...
function MyLikedGalleryItem({ photo, handleImageClick, index, openShareModal, contestId, randomPhotos, setrandomPhotos,contestsClosed}) {

  return (
    <div className="gallery-item-container">
      <div className="content-block">
        <div
          className="gallery-item-photo-container"
...
export default MyLikedGalleryItem
